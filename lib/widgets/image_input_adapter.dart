  ...
  Widget widgetize() {
    if (file != null) {
      ...
      return FadeInImage(
        ...
        placeholder: AssetImage('images/category_logo.png'),
        fit: BoxFit.contain,
      );
    }
  }
...
class UploadableImage {
  ...
  Future<UploadResponse?> save({String? imageTitle, bool editing = false}) async {
    try{
      imageTitle = basename(image.path);
      final _refPath = '$storagePath/$imageTitle';
